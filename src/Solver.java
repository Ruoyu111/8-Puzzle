...
public class Solver {
    ...
    public Solver(Board ini) {
        if (ini == null) throw new IllegalArgumentException("passed a null argument");
    ...
    public Iterable<Board> solution() {
        if (isSolvable()) return initialSolv;
        else return null;
    ...
    private class ByManhattan implements Comparator<SearchNode> {
        public int compare(SearchNode b1, SearchNode b2) {
            ...
            if (b1Manhattan < b2Manhattan) return -1;
            else if (b1Manhattan > b2Manhattan) return +1;
            else return 0;
        }
    }
